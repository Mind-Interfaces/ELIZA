...
KEYWORDS = [
    ...
    ['(.*) i am sad (.*)',
     ["I am sorry to hear that you are unhappy {1}.",
      "Do you think coming here will help you not to be depressed {1}?",
      "I'm sure it's not pleasant to be unhappy {1}.",
      "Can you explain what made you unhappy {1}?",
      "You sound really depressed.",
      "Do you feel inadequate because you are unhappy {1}?"]],
